...
- **digital-twins-xai-medical-device-qa** – Research proposal on Digital Twins + XAI  
- **predictive-analytics-qa-medical-devices** – Literature review on predictive QA  
- **python-stock-analysis** – Big‑data stock analysis pipeline  
- **nosql-data-analysis-tutorials** – MongoDB CMS & Neo4j fraud detection tutorials  
- **faulty-medical-devices-analysis** – Analysis of defective medical‑device event data  
